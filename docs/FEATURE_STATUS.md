...
| FEAT-025 | 추가형 효과 카드·선택 메뉴 | EFFECT-002 | 1.3.0 / 1.3.0 | 부분 완료 | Stage 4, `ui_state.py` | 연결 | 연결 | migration 연결 | 빈 상태·검색·키보드·reset·deep-copy UI 테스트 | 계층형 category submenu·edge flip 미구현; 카드 순서는 inspector 순서 |
